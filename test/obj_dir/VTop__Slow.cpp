...
void VTop::_settle__TOP__2(VTop__Syms* __restrict vlSymsp) {
    ...
    VTop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if ((1U & (~ vlTOPp->Top__DOT____Vtogcov__io_imem_req_valid))) {
        ++(vlSymsp->__Vcoverage[3]);
        vlTOPp->Top__DOT____Vtogcov__io_imem_req_valid = 1U;
    }
    if ((1U & vlTOPp->Top__DOT____Vtogcov__io_imem_req_bits_data)) {
        ++(vlSymsp->__Vcoverage[36]);
        vlTOPp->Top__DOT____Vtogcov__io_imem_req_bits_data 
            = (0xfffffffeU & vlTOPp->Top__DOT____Vtogcov__io_imem_req_bits_data);
    }
